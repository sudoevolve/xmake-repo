package("eui-neo")
    ...
    on_install("windows", "mingw", "linux", "macosx", function(package)
        ...
        import("package.tools.xmake").install(package, {
            window_backend = package:config("window_backend"),
            render_backend = package:config("render_backend"),
            markdown = package:config("markdown"),
            vulkan_low_latency = package:config("vulkan_low_latency")
        })
    end)
